            ...
            >
              ...
              <div className="flex items-baseline justify-between gap-3 mb-3">
                <span
                  className={`text-xs font-bold tracking-[0.14em] uppercase ${
                    tier.primary ? "text-brand-soft" : "text-brand"
                  }`}
                >
                  {tier.label}
                </span>
                <span
                  className={`text-[10px] font-semibold tracking-wide ${
                    tier.primary ? "text-white/60" : "text-muted-foreground"
                  }`}
                >
                  {tier.slots}
                </span>
              ...
              <p
                className={`text-sm leading-relaxed mb-4 ${
                  tier.primary ? "text-white/80" : "text-muted-foreground"
                }`}
              >
                {tier.body}
              </p>
              <div
                className={`text-xs italic leading-relaxed mb-6 ${
                  tier.primary ? "text-white/70" : "text-muted-foreground"
                }`}
              >
                {tier.exchange}
              </div>
              <div
                className={`mt-auto pt-4 text-xs font-semibold inline-flex items-center gap-1.5 ${
                  tier.primary ? "text-brand-soft" : "text-navy-900"
                }`}
              >
