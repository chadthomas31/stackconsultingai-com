---
issue: The Stack Report #2
subject: 35 trending GitHub repos, 10 you'll actually use
preheader: Agent memory that doesn't forget, a Gmail client in 60KB, and a Postgres trick that replaces ElasticSearch.
source: Hacker News Show #4 (YouTube, GitHub Awesome channel, ~15 min)
source_url: https://www.youtube.com/watch?v=mYU9vcvL-yk
---
