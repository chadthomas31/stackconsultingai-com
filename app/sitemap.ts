...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/tools/automation-finder`, lastModified: new Date('2026-06-12'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/tools/site-audit`, lastModified: new Date('2026-06-12'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/try`, lastModified: new Date('2026-06-12'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/privacy`, lastModified: new Date('2026-06-12'), changeFrequency: 'yearly', priority: 0.2 },
    { url: `${baseUrl}/terms`, lastModified: new Date('2026-06-12'), changeFrequency: 'yearly', priority: 0.2 },
    ...
    { url: `${baseUrl}/demos/hvac`, lastModified: new Date('2026-05-28'), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/demos/plumbing`, lastModified: new Date('2026-05-28'), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/demos/auto`, lastModified: new Date('2026-05-28'), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/demos/medspa`, lastModified: new Date('2026-05-28'), changeFrequency: 'weekly', priority: 0.9 },
