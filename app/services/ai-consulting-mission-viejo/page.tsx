...
export const metadata: Metadata = {
  title: "AI Consulting Mission Viejo | Voice Agents & Automation for Mission Viejo Small Businesses | Stack Consulting AI",
  description:
    "Founder-led AI consulting in Mission Viejo, CA. We build voice agents, chatbots, and automations for South OC small businesses. SoCal team. Free 30-minute assessment.",
  keywords: [
