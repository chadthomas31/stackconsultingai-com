...
export const metadata: Metadata = {
  title: "AI Consulting Costa Mesa | Voice Agents & Automation for Costa Mesa Small Businesses | Stack Consulting AI",
  description:
    "Founder-led AI consulting in Costa Mesa, CA. We build voice agents, chatbots, and automations for restaurants, retail, and SOCO-area businesses. Free assessment.",
  keywords: [
...
const config: CityConfig = {
  ...
  slug: "costa-mesa",
  cityFlavor:
    "Costa Mesa is restaurants, retail, design studios, the SOCO and the Lab area, plus a long tail of small services and contractors. These are businesses that live or die on customer experience — answering the phone, taking the reservation, returning the question on Instagram before someone else does. AI voice agents and chatbots are particularly good fits because they cover the after-hours and weekend gap that small teams can't.",
  presenceAnswer:
