...
export default async function InvoiceDetailPage({
  ...
  return (
    <div className="p-4 sm:p-8">
      <Link href="/invoices" className="text-sm text-blue-600 hover:text-blue-700">&larr; Back to invoices</Link>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 text-sm sm:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-1 text-zinc-900">
              {invoice.project ? (
                <Link href={`/projects/${invoice.project.id}`} className="text-blue-600 hover:text-blue-700">
